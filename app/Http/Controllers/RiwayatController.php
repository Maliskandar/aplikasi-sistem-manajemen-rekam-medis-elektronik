...
class RiwayatController extends Controller
{
    public function kebidanan()
    {
        ...
        return view('asisten.riwayat.kebidanan', compact('services'));
    }
    ...
    public function bayi()
    {
        ...
        return view('asisten.riwayat.bayi', compact('services'));
    }
    ...
    public function umum()
    {
        ...
        return view('asisten.riwayat.umum', compact('services'));
    }
    ...
    public function semua()
    {
        ...
        return view('asisten.riwayat.semua', compact('services'));
    }
    ...
    public function detail($id)
    {
        ...
        return view('asisten.riwayat.detail', compact('service', 'anc', 'resep'));
    }
    ...
    public function cetak($id)
    {
        ...
        $pdf = Pdf::loadView('asisten.riwayat.cetak-pdf', compact('service', 'anc', 'resep'));
