...
@section('content')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse mb-2">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Edit Kucing</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    @endif
    <h1 class="text-2xl font-bold mb-4 text-gray-700 dark:text-gray-400">Edit Kucing</h1>
    <form action="{{ route('customer.kucing.update', $kucing->id_kucing) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <textarea name="info_kesehatan"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-2"
                required>{{ $kucing->info_kesehatan }}</textarea>
        </div>
        <button type="submit"
