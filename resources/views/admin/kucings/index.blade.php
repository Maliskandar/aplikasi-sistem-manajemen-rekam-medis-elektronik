...
@section('content')
    ...
    {{-- <a href="{{ route('admin.kucings.create') }}"
        ...
        <tbody>
            @foreach ($kucings as $kucing)
                <tr class="dark:hover:bg-gray-700 hover:bg-gray-100">
                    ...
                    <td
                        class="py-6 px-4 mb-2 text-center border-b dark:border-gray-600 border-gray-300 bg-transparent dark:text-gray-400 text-gray-700">
                        {{ $kucing->info_kesehatan }}</td>
                    <td
                        class="py-6 px-4 mb-2 text-center border-b dark:border-gray-600 border-gray-300 bg-transparent dark:text-gray-400 text-gray-700">
                        {{ $kucing->customer->nama ?? 'Tidak Ada' }}</td>
                    <td
                        class="py-6 px-4 mb-2 text-center border-b dark:border-gray-600 border-gray-300 bg-transparent dark:text-gray-400 text-gray-700">
                        <form action="{{ route('admin.kucings.destroy', $kucing->id_kucing) }}" method="POST"
