        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse mb-2">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Daftar Kandang</span>
                </div>
            </li>
        </ol>
    </nav>
    <!-- Breadcrumbs End -->
    <h1 class="text-2xl font-bold mb-4 text-gray-700 dark:text-gray-400">Daftar Kandang</h1>
        ...
        <tbody>
            @foreach ($kandang as $index => $item)
                <tr class="dark:hover:bg-gray-700 hover:bg-gray-100">
                    ...
                    <td
                        class="ppy-6 px-4 mb-2 text-center border-b dark:border-gray-600 border-gray-300 bg-transparent dark:text-gray-400 text-gray-700">
                        <a href="{{ route('admin.kandang.edit', $item->id_kandang) }}" class="btn btn-warning btn-sm"><svg
                                class="w-6 h-6 inline align-middle" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="m14.3 4.8 2.9 2.9M7 7H4a1 1 0 0 0-1 1v10c0 .6.4 1 1 1h11c.6 0 1-.4 1-1v-4.5m2.4-10a2 2 0 0 1 0 3l-6.8 6.8L8 14l.7-3.6 6.9-6.8a2 2 0 0 1 2.8 0Z" />
                            </svg></a>
                        <form action="{{ route('admin.kandang.destroy', $item->id_kandang) }}" method="POST"
                            style="display:inline-block;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm"><svg class="w-6 h-6 inline align-middle"
