...
@section('content')
    <div class="container">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse mb-2">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tambah
                            Kandang</span>
                    </div>
                </li>
            </ol>
        ...
        <!-- Breadcrumbs End -->
        <h1 class="text-2xl font-bold mb-4 text-gray-700 dark:text-gray-400">Tambah Kandang</h1>
        <form action="{{ route('admin.kandang.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    id="ukuran" name="ukuran" required>
            </div>
            <div class="mb-3">
