...
@section('content')
    ...
    <!-- Breadcrumbs End -->
    <h1 class="text-2xl font-bold mb-4 text-gray-700 dark:text-gray-400">Daftar Customers</h1>
    ...
    <table
        ...
        <tbody>
            @foreach ($customers as $customer)
                <tr class="dark:hover:bg-gray-700 hover:bg-gray-100 class="py-6 px-4 mb-2 text-center border-b
                    dark:border-gray-600 border-gray-300 bg-transparent dark:text-gray-400 text-gray-700"">
                    <td
                    ...
                    <td
                        ...
                        <form action="{{ route('admin.customers.destroy', $customer->id_customer) }}" method="POST"
                            ...
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')"><svg
                                    class="w-6 h-6 inline align-middle" aria-hidden="true"
