            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="kucing"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Profil Kucing</span>
                    </a>
                </li>
                <li>
                    <a href="reservasi"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Reservasi Penitipan</span>
                    </a>
                </li>
                {{-- <li>
                    <a href="#"
                ...
                <li>
                    <a href="tracking"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Tracking Status Kucing</span>
                    </a>
                </li>
                <li>
