...
<body class="bg-gray-100">
    ...
    <section class="flex justify-center items-center pt-28 pb-44">
        <div class="w-full max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md">
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                <h5 class="text-xl font-medium text-gray-900">Login to Your Account</h5>
                @csrf
                ...
                <p>Belum punya akun? <a class="text-blue-700" href="{{ route('register') }}">Register</a></p>
            </form>
